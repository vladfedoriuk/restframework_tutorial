...
class UserViewSet(viewsets.ReadOnlyModelViewSet):
    """
    This view automatically provides .list and .retrieve actions
    """
...
class SnippetViewSet(viewsets.ModelViewSet):
    """
    This viewset automatically provides .list, .retrieve, .create,
    .update, .partial_update and .destroy actions.

    Additionally we also provide a custom highlight action
    """
